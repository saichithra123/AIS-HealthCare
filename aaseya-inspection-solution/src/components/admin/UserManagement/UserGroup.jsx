...
const UserGroup = () => {
            ...
            renderCell: (params) => {
                return (
                    <Button
                        ...
                        onClick={() => {
                            navigate(`/user-management/group/add`, { state: { groupId: params.row?.groupId } });
                        }}
                    >
                        Edit
                    </Button>
    ...
    const getUserGroups = async () => {
        const response = await axios({
            method: "get",
            url: `${import.meta.env.VITE_BASE_URL}/getAllUserGroups?page=${page - 1}&size=${pageSize}`,
        });
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Button
                                onClick={() => navigate("/user-management/group/add")}
                                variant="contained"
                                startIcon={<AddIcon />}
                                sx={{
                                    backgroundColor: `${theme.palette.colors[11]}`,
