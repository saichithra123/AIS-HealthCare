...
import { Box, Typography, Button, IconButton, useTheme, Divider, Tooltip, Chip } from "@mui/material";
...
const Skills = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => {
                return (
                    <>
                        {params.row?.inspectiontype?.map((inspectionType) => (
                            <Chip
                                sx={{ borderRadius: "4px", mr: 1, height: "26px" }}
                                key={inspectionType}
            ...
            renderCell: (params) => {
                return (
                    <Button
                        ...
                        onClick={() => {
                            navigate(`/configurations/skills/add`, { state: { skillId: params.row?.skillId } });
                        }}
                    >
                        Edit
                    </Button>
    ...
    const getSkills = async () => {
        const response = await axios({
            method: "get",
            url: `${import.meta.env.VITE_BASE_URL}/getSkills?page=${page - 1}&size=${pageSize}`,
        });
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <Button
                                onClick={() => navigate("/configurations/skills/add")}
                                variant="contained"
                                startIcon={<AddIcon />}
                                sx={{
