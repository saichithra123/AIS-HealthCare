...
import { Box, Typography, useTheme, Button, Divider, IconButton, Tooltip, Chip } from "@mui/material";
...
const AdminInspection = () => {
        ...
        },
        {
            ...
            renderCell: (params) => (
                <Button
                    ...
                    onClick={() => {
                        navigate(`/configurations/inspection-type/add`, { state: { inspectionTypeId: params.row?.insTypeId } });
                    }}
                >
                    Edit
                </Button>
    ...
    const getInspectionTypes = async () => {
        const response = await axios({
            method: "get",
            url: `${import.meta.env.VITE_BASE_URL}/getAllInspectionTypesWithSkills?page=${page - 1}&size=${pageSize}`,
        });
        setInspectionTypes(response?.data?.content);
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <Button
                                onClick={() => navigate("/configurations/inspection-type/add")}
                                variant="contained"
                                startIcon={<AddIcon />}
                                sx={{
