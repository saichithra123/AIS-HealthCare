...
import { Box, Typography, useTheme, Button, Divider, IconButton, Tooltip } from "@mui/material";
            ...
            renderCell: (params) => {
                return (
                    <Button
                        ...
                        onClick={() => {
                            navigate(`/checklist-management/category/add`, { state: { categoryId: params.row?.checklistCatId } });
                        }}
                    >
                        Edit
                    </Button>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Button
                                    onClick={() => navigate("/checklist-management/category/add")}
                                    variant="contained"
                                    startIcon={<AddIcon />}
                                    sx={{
                                        backgroundColor: `${theme.palette.colors[11]}`,
...
export default AdminChecklistCategory;
